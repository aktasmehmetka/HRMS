...
import com.hrms.pages.AddEmployeePageElements2;
...
public class AddEmployeePageTest2 extends CommonMethods{
    ...
    public void addMultipleEmpoyee(String firstName, String middleName, String lastName) throws InterruptedException {
        ...
        AddEmployeePageElements2 addEmp=new AddEmployeePageElements2();
        test.info("Login in into HRMS");
